...
in
{
  ...
  config = {
    ...
    nixpkgs.config.allowUnfreePredicate = lib.mkIf cfg.parallels.enable (
    ...
    # update microcode
    hardware.cpu.amd.updateMicrocode = lib.mkIf (cfg.none.enable && facterLib.isCpuAmd report) (
      lib.mkDefault config.hardware.enableRedistributableFirmware
    );
    hardware.cpu.intel.updateMicrocode = lib.mkIf (cfg.none.enable && facterLib.isCpuIntel report) (
      lib.mkDefault config.hardware.enableRedistributableFirmware
    );
  };
}
